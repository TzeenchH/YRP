    ...
    fs.readFile(pathToFile, this.options.encoding, (function(_this) {
      return function(err, content) {
        ...
        imports.forEach(function(importStr) {
          var arRelative, dfd, disableWarningsRegExp, fileExt, fileName, fileNameFromImport, filePathFromImport, fullPath, fullPathWrong, isWrongFileName, relativePath, relativePathWrong, shouldCheckForWrongName, shouldReturn, wrongFileContents;
          dfd = Deferred.defer();
          ...
          if (shouldCheckForWrongName) {
            ...
            if (isWrongFileName) {
              ...
              if (!disableWarningsRegExp.test(wrongFileContents)) {
